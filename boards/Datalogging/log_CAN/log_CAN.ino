...
#define SDLOG true         // Set to true to log to data file
  ...
  if (!AHRS)
  {
    ...
    if (myIMU.delt_t > 500)
    {
      ...
      if(SDLOG)
      {
        ...
        // Print gyro values in degree/sec
        datafile.print("X-gyro rate: "); datafile.print(myIMU.gx, 3);
        datafile.print(" degrees/sec ");
        datafile.print("Y-gyro rate: "); datafile.print(myIMU.gy, 3);
        datafile.print(" degrees/sec ");
        datafile.print("Z-gyro rate: "); datafile.print(myIMU.gz, 3);
        datafile.println(" degrees/sec");

        // Print mag values in degree/sec
        datafile.print("X-mag field: "); datafile.print(myIMU.mx);
        datafile.print(" mG ");
        datafile.print("Y-mag field: "); datafile.print(myIMU.my);
        datafile.print(" mG ");
        datafile.print("Z-mag field: "); datafile.print(myIMU.mz);
        datafile.println(" mG");
        ...
        myIMU.temperature = ((float) myIMU.tempCount) / 333.87 + 21.0;
        // Print temperature in degrees Centigrade
        datafile.print("Temperature is ");  datafile.print(myIMU.temperature, 1);
